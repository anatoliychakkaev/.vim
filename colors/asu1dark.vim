...
hi Cursor       ctermfg=Gray       ctermbg=Cyan
hi lCursor      ctermfg=White       ctermbg=Cyan
hi LineNr       term=NONE cterm=NONE ctermfg=Red         ctermbg=Black

" GUI Color Scheme
hi Normal       gui=NONE     guifg=White   guibg=#110022
hi NonText      gui=NONE     guifg=#4a4a59 guibg=#444444
hi SpecialKey   gui=NONE     guifg=#4a4a59 guibg=#444444
hi Function     gui=NONE     guifg=#7788ff guibg=#110022
hi Statement    gui=BOLD     guifg=Yellow  guibg=#110022
hi Special      gui=NONE     guifg=#4a4a59 guibg=#110022
